...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, Spring Boot DevTools'. As a
...
```
$ docker run --rm -p 8080:8080 delivery_microservice:0.0.1-SNAPSHOT
```
